...
func (self *Executor) SetStatus(status int32) {
	C.WasmEdge_ExecutorSetStatus(self._inner, C.int32_t(status))
}

func (self *Executor) GetStatus() int32 {
	return int32(C.WasmEdge_ExecutorGetStatus(self._inner))
}
